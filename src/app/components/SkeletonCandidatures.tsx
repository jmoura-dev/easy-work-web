...
export function SkeletonCandidatures() {
  return (
    <>
      <h1 className="mb-4 text-center font-mirza text-2xl font-semibold text-zinc-800 lg:text-3xl 2xl:text-4xl">
    ...
    focus-within:ring-violet-100 md:max-w-96 lg:mb-16 lg:max-w-2xl"
      ...
      <div className="flex flex-col gap-3 pt-4 md:grid md:grid-cols-2 3xl:grid-cols-3">
